...
export const SettingsForm = ({ initialData }: SettingsFormProps) => {
    ...
    const onSubmit = async (values: SettingsFormValues) => {
        try {
            ...
            // Vuelve a actualizar el componente padre. Puede ser server component 🤔
            router.refresh()
            toast({
    ...
    const onDelete = async () => {
        try {
            ...
            toast({
                title: 'Something went wrong',
                description: 'Make sure you have deleted all products and categories before deleting the store.',
                variant: 'destructive'
            })
        } finally {
            setLoading(false)
